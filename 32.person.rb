...
# We're going to learn how to define classes in Ruby and create custom Ruby objects from those classes.
...
#
# The main point of this file is to show you how to define a class, create new instance objects, and define
...
class Person
    ...
    # The first_name instance methods returns the value of the @first_name instance variable
    def first_name
      @first_name
    end
  
    # The last_name instance methods returns the value of the @last_name instance variable
    def last_name
      @last_name
    end
  
    # The first_initial instance method returns the first letter of this person's *first* name
    def first_initial
      self.first_name[0]
    end
  
    # The last_initial instance method returns the first letter of this person's *last* name
    def last_initial
      self.last_name[0]
    end
    ...
    # i.e., the first letter of their first name concatenated with the first letter of their last name
    def initials
