...
# Your job is to implement the Die#roll instance method.  
# We've hard-coded the number of sides and assigned it to the @sides instance variable --
# don't change that!
...
class Die
  ...
  # Don't change any of this code.  It's here to tell you when your method isn't working.  
  # Since we're dealing with random behavior, 
  # there's a (small) chance that this code will run even if your Die#roll method isn't working.
